...
const countries = [
  ...
  return (
    <>
      ...
      <button className={style.addmepmr} onClick={handleOpen}><h1>+</h1> &nbsp; Add New PMR</button>
      <Modal
        open={open}
        onClose={handleClose}
      ...
      autoComplete="off"
    >
      <TextField id="outlined-basic" type='text' label="Client Name *" variant="outlined" />
       <Autocomplete
    ...
    />
      <TextField id="outlined-basic" type='telephone' label="Phone Number *" variant="outlined" />
